...
TheeTheme is a starter theme for WordPress.
...
Check out the [project wiki](https://github.com/theedigital/TheeTheme/wiki) to learn how to install and set up the theme.

## Copyright and License

TheeTheme is licensed under the [GNU GPL](https://www.gnu.org/licenses/gpl-2.0.html), version 2 or later.

2018 &copy; TheeDigital.
